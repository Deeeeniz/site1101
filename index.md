...
<div class="cv-container">
  ...
  <div class="right-col">
    <nav class="cv-nav">
      <a href="{{ '/' | relative_url }}" class="nav-btn active">Home</a>
    ...
    <main class="cv-content">
      <section class="cv-section active">
        ...
        <div class="home-content">
          <p>Software engineer focused on systems programming, with interests spanning performance, embedded software, and AI infrastructure.</p>
