...
<div class="cv-container">
  ...
  <div class="right-col">
    <nav class="cv-nav">
      ...
      <a href="{{ '/about' | relative_url }}" class="nav-btn active">About</a>
    ...
    <main class="cv-content">
      <section class="cv-section active">
        ...
        <div class="about-content">
          <p>
            Software engineer focused on systems programming, with interests spanning performance, embedded software, and AI infrastructure.
          </p>
          <p>
            AI is a turning point in human history, and instead of resisting it as we have with past industrial revolutions, we should embrace it and focus on extracting what is beneficial. One of my aspirations is to explore how AI can be incorporated into decision-making and governance.
          </p>
