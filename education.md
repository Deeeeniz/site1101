---
layout: default
title: Education - Mahammad Sheykhov
permalink: /education/
---
...
<div class="cv-container">
  ...
  <div class="right-col">
    <nav class="cv-nav">
      ...
      <a href="{{ '/education' | relative_url }}" class="nav-btn active">Education</a>
        ...
        <div class="timeline">
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              ...
              <p class="date">08/09/2025 – Current</p>
              <p class="location">Baku, Azerbaijan</p>
              <p class="field">Field of study: Software and applications development and analysis</p>
              <p class="level">Level in EQF: 6</p>
              <a href="https://www.ada.edu.az" class="external-link" target="_blank">Visit Website →</a>
            </div>
          </div>
          ...
          <div class="timeline-item">
            <div class="timeline-marker"></div>
            <div class="timeline-content">
              <h3>Scratch, Java, MySQL and Web Development</h3>
              <p class="institution">Developia</p>
              <p class="date">2019 – 2022</p>
              <p class="location">Baku, Azerbaijan</p>
              <ul class="course-list">
                <li>Scratch Programming & Game Development</li>
